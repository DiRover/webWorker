...
;// CONCATENATED MODULE: ./src/js/ListRender.js




function ListRender_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ListRender_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ListRender_createClass(Constructor, protoProps, staticProps) { if (protoProps) ListRender_defineProperties(Constructor.prototype, protoProps); if (staticProps) ListRender_defineProperties(Constructor, staticProps); return Constructor; }

var ListRender = /*#__PURE__*/function () {
  // класс для списка задач
  function ListRender(store, hashBox, container) {
    ListRender_classCallCheck(this, ListRender);
  ...
  ListRender_createClass(ListRender, [{
    key: "init",
    value: function init() {
      var _this = this;
...
;// CONCATENATED MODULE: ./src/js/web.worker.js
function Worker_fn() {
  return new Worker(__webpack_require__.p + "web.worker.worker.js");
}
;// CONCATENATED MODULE: ./src/js/workerOnload.js
...
function workerOnload(_ref) {
  ...
  if (window.Worker) {
    ...
    var worker = new Worker_fn(); // создаём инстанс воркера
...
;// CONCATENATED MODULE: ./src/js/hashAlgorithms.js
/* eslint-disable import/prefer-default-export */
var hashAlgorithms = ['MD5', 'SHA1', 'SHA256', 'SHA512']; // список алгоритмов вычисления
...
var store = new Store(hashAlgorithms); // класс для создания и управления потоками

var listRender = new ListRender(store, hash, algorithm); // класс для отрисовки элементов страницы
...
fromEvent(algorithm, 'click').subscribe(function (e) {
